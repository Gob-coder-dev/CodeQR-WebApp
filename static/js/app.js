const elements = {
  ...
  wifiSsidField: document.querySelector("#wifi-ssid"),
  wifiSecurityField: document.querySelector("#wifi-security"),
  wifiPasswordField: document.querySelector("#wifi-password"),
  contactFirstNameField: document.querySelector("#contact-first-name"),
  contactOrgField: document.querySelector("#contact-org"),
  ...
  delightTargets: {
    ...
    contact: document.querySelector("#contact-delight"),
    wifi: document.querySelector("#wifi-delight"),
  },
